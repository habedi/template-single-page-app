...
Please check the [issue tracker](https://github.com/habedi/template-single-page-app/issues) to see if there is an issue
you
would like to work on or if it has already been resolved.

#### Reporting Bugs

1. Open an issue on the [issue tracker](https://github.com/habedi/template-single-page-app/issues).
